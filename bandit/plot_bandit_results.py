...
axs[0, 0].set_title('expected_{}'.format(alpha))
tools.plot_learning_curves(ax1=axs[0, 0], ax2=axs[1, 0],
...
for eta_flag in ['pi', 'zero']:
    ...
    axs[0, idx].set_title('{}_{}_{}'.format(eta_flag, baseline_flag, alpha))
    tools.plot_learning_curves(ax1=axs[0, idx], ax2=axs[1, idx],
                               folder_name=folder_name,
                               pg_type='stochastic_pg', eta_flag=eta_flag,
    ...
    axs[0, idx].set_title('{}_{}\n{}_{}'.format(
        eta_flag, baseline_flag, alpha, beta))
    tools.plot_learning_curves(ax1=axs[0, idx], ax2=axs[1, idx],
                               folder_name=folder_name,
                               pg_type='stochastic_pg', eta_flag=eta_flag,
                               baseline_flag=baseline_flag,
