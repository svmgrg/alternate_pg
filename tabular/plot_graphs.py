...
policy_stepsize_list = [2**i for i in range(-6, 15, 2)]
critic_stepsize_list = [2**i for i in range(-4, 4)]

end_plotting_episode = 100
start_plotting_episode = end_plotting_episode - 10

folder_name = 'mdp_data_large/linearChain__thetaInit_{}_{}__valueWeightInit_{}'\
